...
static char const*const BLUE_LED_FILE
...
static char const*const LCD_FILE
        = "/sys/class/backlight/bd6084gu-bl/brightness";

static char const*const ALS_FILE
        = "/sys/class/leds/lcd-backlight/alc";

/*static char const*const BLUE_BLINK_FILE
...
static char const*const KEYBOARD_FILE
        ...
        struct light_state_t const* state)
{
    ...
    int calculated = brightness/4;
    
    if (64 < calculated) {
      calculated = 64;
    } else if (1 > calculated) {
      calculated = 1;
    }
    ...
    LOGE("ALS_MODE %d, new_bright %d \n", als_mode, calculated);
    pthread_mutex_lock(&g_lock);
    err = write_int(ALS_FILE, als_mode);
    err = write_int(LCD_FILE, calculated);
